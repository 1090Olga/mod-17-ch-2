...
def calculate_average(nambers):
    try:
        summ_ = personal_sum(nambers)
        summ_ = summ_[0]
    except TypeError:
        print('B numbers записан некорректный тип данных')
        return None
    try:
        mid = summ_ / (len(nambers)-summ_[1])
